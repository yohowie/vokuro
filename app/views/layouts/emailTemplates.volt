<html lang="en">
    ...
    <body style="background-color:#e4e4e4;padding:20px;margin:0;min-width:640px;">
        <table border="0" cellspacing="0" width="530" style="color:#262626;background-color:#fff;padding:27px 30px 20px 30px;margin:auto;border:1px soldi #e1e1e1;">
            <tbody>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" style="padding-bottom:9px;" align="right">
                            ...
                            <tr style="border-bottom:1px solid #999999;">
                                <td width="24" style="padding:0 7px 0 0;">
                                    <a href="https://phalcon.io/facebook" style="border-width:0;">
                                        <img src="//{{ publicUrl }}/img/facebook.gif" width="24" height="24" alt="Facebook Image">
                                    </a>
                                </td>
                                <td width="24">
                                    <a href="https://phalcon.io/twitter" style="border-width:0;">
